...
- **Tailors resumes for specific positions** -- ATS-optimized CVs customized per job description
...
Career-ops is agentic: Claude Code, Codex, and OpenCode can navigate career pages with Playwright, evaluate fit by reasoning about your CV vs the job description (not keyword matching), and adapt your resume per listing.
...
| **ATS PDF Generation** | Role-specific resume tailoring with keyword alignment and exportable PDFs |
| **Portal Scanner** | 45+ companies pre-configured (Anthropic, OpenAI, ElevenLabs, Retool, n8n...) + custom queries across Ashby, Greenhouse, Lever, Wellfound |
| **Batch Processing** | Parallel evaluation with `claude -p` workers |
| **Dashboard TUI** | Terminal UI to browse, filter, and sort your pipeline |
| **Permission-Gated Apply Assist** | For explicitly approved jobs, tailors the resume, helps fill the application, and stops for final user review |
...
# Codex: use AGENTS.md or skills/job-search/SKILL.md
# Claude Code: use .claude/skills/career-ops/SKILL.md
...
- `AGENTS.md` for clients that auto-load project instructions
- `skills/job-search/SKILL.md` for clients that prefer a repo-local skill entrypoint

Both paths route into the same checked-in `modes/*`, scripts, templates, and tracker flow. There is no separate Codex-only implementation.
...
/career-ops apply          → Fill approved application forms with AI
